### Analysis Objective
As the spread of Covid-19, the NYC Department of Health and Mental Hygiene(NYC DOHMH) plans to provide some resources such as free masks, sanitizers and booklets with health guidance in subway stations to protect the public's health against Covid. In order to better allocate those resources, we'd like to:
